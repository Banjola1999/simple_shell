 ...
 * @final_exit: the exit status of the last command executed
 * @ln_count: the number of commands executed in the shell
 */
struct info
{
	int final_exit;
 ...
 * @interactive: indicates if the shell is running in interactive mode
 */
struct flags
{
	bool interactive;
